								...
								<div class="row align-items-center justify-content-center">
									...
									<div class="col-md-12 col-lg-6 login-right">
										<div class="login-header">
											<h3>Doctor Register <a href="studentRegister.php">Not a Doctor?</a></h3>
										</div>
										...
										<form action="" method="POST">
											<div class="form-group form-focus">
												...
												<label class="focus-label">example@ucc.edu.gh</label>
											</div>
											<div class="form-group form-focus">
											...
											<button class="btn btn-primary btn-block btn-lg login-btn" type="submit" name="doc_submit">Signup</button>
											<div class="login-or">
